    ...
    def initialize(self):
        ...
        for section in sections:
            ...
            if n > 0:
                ...
                classes_per_course = n // len(courses)

                for course in courses:
                    crs_inst = course.instructors.all()

                    # Calculate the correct number of classes per course
                    if n >= len(courses):
                        classes_per_course_current = classes_per_course
                    else:
                        classes_per_course_current = n

                    for i in range(classes_per_course_current):
